...
1. A player looses his ENTIRE score when he rolls two 6 in a row. After that, 
    it's the next player's turn. (Hint: Always save the previous dice roll in a separate 
    variable)
...
2. Add an input field to the HTML where players can set the winning score, so that 
    ...
    value property in JavaScript. This is a good oportunity to use google to figure 
    this out :)
...
document.querySelector('.btn-hold').addEventListener('click', function() {
    ...
    if(gamePlaying) {
        ...
        var winningScore;
        // undefined, 0, null, or "" are coercedto false and anything else is coerced to true
            if(input) {
...
document.querySelector('.btn-new').addEventListener('click', init);
    ...
    function init() {
        ...
        // document.querySelector('.lost-round-' + activePLayer).style.display = none;
    }